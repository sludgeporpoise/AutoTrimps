...
MODULES["automaps"].MapTier1Sliders = [9,9,9,'Mountain']; //Zone 47-72 (old: 9/9/4 Metal)
...
MODULES["automaps"].preferGardens = false;   //prefer run Garden maps instead of ^^ if we have Decay done
